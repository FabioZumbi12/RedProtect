...
import static br.net.fabiozumbi12.RedProtect.Bukkit.commands.CommandHandlers.handleRename;
...
public class RenameCommand implements SubCommand {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        RPLang.sendCommandHelp(sender, "rename", true);
        return true;
    }

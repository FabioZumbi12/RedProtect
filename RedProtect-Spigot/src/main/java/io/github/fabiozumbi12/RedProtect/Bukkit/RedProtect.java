...
package io.github.fabiozumbi12.RedProtect.Bukkit;

import io.github.fabiozumbi12.RedProtect.Bukkit.API.RedProtectAPI;
import io.github.fabiozumbi12.RedProtect.Bukkit.commands.CommandHandler;
import io.github.fabiozumbi12.RedProtect.Bukkit.config.BlockConfig;
import io.github.fabiozumbi12.RedProtect.Bukkit.config.ConfigManager;
import io.github.fabiozumbi12.RedProtect.Bukkit.config.LangGuiManager;
import io.github.fabiozumbi12.RedProtect.Bukkit.config.LangManager;
import io.github.fabiozumbi12.RedProtect.Bukkit.helpers.*;
import io.github.fabiozumbi12.RedProtect.Bukkit.hooks.HooksManager;
import io.github.fabiozumbi12.RedProtect.Bukkit.listeners.*;
import io.github.fabiozumbi12.RedProtect.Bukkit.metrics.Metrics;
import io.github.fabiozumbi12.RedProtect.Bukkit.region.RegionManager;
import io.github.fabiozumbi12.RedProtect.Bukkit.schematics.RPSchematics;
...
public class RedProtect extends JavaPlugin {
    ...
    private void startLoad() throws Exception {
        ...
        if (bukkitVersion >= 1.19) {
            rpvHelper = (VersionHelper) Class.forName("io.github.fabiozumbi12.RedProtect.Bukkit.helpers.VersionHelperLatest").newInstance();
        } else {

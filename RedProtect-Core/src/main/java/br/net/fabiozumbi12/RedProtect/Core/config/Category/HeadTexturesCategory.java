 ...
 * Last Modified: 24/06/2024 17:06
 *
...
public class HeadTexturesCategory {
    ...
    @Setting(value = "mob-textures", comment = "Use https://minecraft-heads.com/custom-heads/ to get textures.\n" +
            "Search for the name of mob, click in a head, scroll down to \"For Developers:\" section and copy \"Value\".")
    public Map<String, String> mobTextures = new HashMap<>();
}

        ...
        return CommandSpec.builder()
                ...
                .executor((src, args) -> {
                    if (!(src instanceof Player)) {
                        ...
                        player.sendMessage(RedProtect.get().getUtil().toText(RedProtect.get().getLanguageManager().get("playerlistener.wand2") + RedProtect.get().getLanguageManager().get("general.color") + " (&6" + pl.getBlockX() + RedProtect.get().getLanguageManager().get("general.color") + ", &6" + pl.getBlockY() + RedProtect.get().getLanguageManager().get("general.color") + ", &6" + pl.getBlockZ() + RedProtect.get().getLanguageManager().get("general.color") + ")."));
                        ...
                        if (RedProtect.get().firstLocationSelections.containsKey(player) && RedProtect.get().secondLocationSelections.containsKey(player)) {
                            ...
                            if (loc1.getPosition().distanceSquared(loc2.getPosition()) > RedProtect.get().getConfigManager().configRoot().region_settings.max_scan && !RedProtect.get().getPermissionHandler().hasPerm(player, "redprotect.bypass.define-max-distance")) {

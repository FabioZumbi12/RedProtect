        ...
        return CommandSpec.builder()
                ...
                .executor((src, args) -> {
                    if (!(src instanceof Player)) {
                        ...
                        int prior = args.<Integer>getOne("priority").get();

                        if (args.hasAny("region"))
                            handlePrioritySingle(player, prior, args.<String>getOne("region").get());
                        else

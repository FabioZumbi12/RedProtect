...
public class SetTpCommand {

    public CommandSpec register() {
        return CommandSpec.builder()
                .description(Text.of("Command to set the teleport location of a region."))
                .permission("redprotect.command.settp")
                .executor((src, args) -> {
